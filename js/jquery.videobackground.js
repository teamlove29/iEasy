...
(function($, document, window) {
    ...
    function play(that) {
        ...
        if (video.paused) {
            video.play();
            controller.toggleClass('fa fa-pause fa-2x fa fa-play fa-2x').text(that.settings.controlText[1]);
        } else {
            if (video.ended) {
                video.play();
                controller.toggleClass('fa fa-pause fa-2x fa fa-play fa-2x').text(that.settings.controlText[1]);
                ...
                video.pause();
                controller.toggleClass('fa fa-pause fa-2x fa fa-play fa-2x').text(that.settings.controlText[0]);
            }
        }
    }
    /*
    ...
    function mute(that) {
        ...
        if (video.volume === 0) {
            video.volume = 1;
            controller.toggleClass('fa fa-volume-up fa-2x fa fa-volume-off fa-2x').text(that.settings.controlText[2]);
        } else {
            video.volume = 0;
            controller.toggleClass('fa fa-volume-up fa-2x fa fa-volume-off fa-2x').text(that.settings.controlText[3]);
        }
    }
    /*
                ...
                if (document.createElement('video').canPlayType) {
                    ...
                    if (!that.settings.initialised) {
                        ...
                        that.controls = $('<ul class="ui-video-background-controls"><li class="ui-video-background-play">'
                                + '<a class="ui-icon fa fa-pause fa-2x" href="#">' + that.settings.controlText[1] + '</a>'
                                + '</li><li class="ui-video-background-mute">'
                                + '<a class="ui-icon fa fa-volume-up fa-2x" href="#">' + that.settings.controlText[2] + '</a>'
                                + '</li></ul>');
                        /*
